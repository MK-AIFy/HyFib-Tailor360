...
| **A11Y-DP-06** — Print, Send to print station and Download PDF distinct and named | **Not applicable to the artefact** — reason: these are **screen controls**, not properties of a rendered document. Answered on the invoice detail screen, delivered by **E09-F02-5** — recorded as **Fail** in [`../nfr/a11y-records/2026-09-15-billing-invoice-screens.md`](../nfr/a11y-records/2026-09-15-billing-invoice-screens.md) section 3.5: the three controls are distinctly named, but Download PDF's success has no announced outcome at all in the source, filed as [#535](https://github.com/MK-AIFy/HyFib-Tailor360/issues/535) |
...
Per `docs/nfr/a11y-checklist.md` section 2.2, this is recorded as missing kit rather than a Pass, once, covering
both this artefact-level pass and the on-screen pass, in
