...
| **OD-13** | Approve the default role-to-permission grants and any custom roles | The quarterly access review in section 5 has nothing to compare against until this exists | Business owner | **Decided 2026-09-19** — approved as shipped, Branch Manager a distinct role. The quarterly review now has an approved baseline to compare against |
