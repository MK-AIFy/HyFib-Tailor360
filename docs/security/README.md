...
| --- | --- | --- | --- |
| `threat-models/<flow>.md` | One model per flow: assets, data flow diagram, trust boundaries, STRIDE table, abuse cases, controls mapped to tests, residual risk | #23 (authentication), #578 (authorisation), then #56a for the rest | [`threat-models/authentication.md`](threat-models/authentication.md) (#23, 2026-09-05) and [`threat-models/authorisation.md`](threat-models/authorisation.md) (#578, 2026-09-19) are **written and reviewed**. The rest are not; the template is [`../templates/threat-model.md`](../templates/threat-model.md) |
...
| [`asvs-traceability.md`](asvs-traceability.md) | ASVS L2 with selected L3: requirement, control, issue or pull request, test, evidence, residual risk, owner, review date | #349 | **Written 2026-09-17,** as the skeleton — 253 Level 2 requirements classified covered/scheduled/not applicable, with `threat-models/authentication.md` section 10 filled in as the worked instance. The per-requirement control, test and evidence audit is the W5 half of #56 |
...
| [`field-visibility.md`](field-visibility.md) | Response view × field × class × permission, and the field set each role is shown, derived from that and from the default grants | #24 | **Written 2026-09-06, not approved.** The mechanism and its invariants are code and are tested. Two of the five declared views are served: `customers.record` and `customers.search_card`, published by #26. The other three wait for #28, #32a and #33. The document's own first paragraph says which is which, so that a reader who never reaches this table is not misled |
| [`role-walkthrough.md`](role-walkthrough.md) | The scripted per-role walkthrough used to demonstrate the authorisation model | #24, completed by #25 and #32a | **Written 2026-09-06. Section 3 run 2026-09-06 and its results recorded**; sections 4 to 6 are not run. #25 shipped the administration surface on 2026-09-07, so the twenty-four users of section 3.2 can now be created through the screens; what remains is endpoints that enforce a permission on business resources (#32a). The administrative rows are also covered by [`../process/uat-administration.md`](../process/uat-administration.md) |
