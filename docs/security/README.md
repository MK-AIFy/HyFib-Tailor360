...
| `permission-matrix.md` | Role × permission × branch scope × step-up flag, with the rationale for each grant | #24 | Not written |
| `role-walkthrough.md` | The scripted per-role walkthrough used to demonstrate the authorisation model | #24 | Not written |
