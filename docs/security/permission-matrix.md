...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `billing.approve_dispatch_exception` | Billing | branch | yes | yes | yes | `owner` | #164 | Single-use, approved by someone other than the dispatcher. The plan's interim position is the Owner only (`raci.md` footnote (15), XQ-02) |
