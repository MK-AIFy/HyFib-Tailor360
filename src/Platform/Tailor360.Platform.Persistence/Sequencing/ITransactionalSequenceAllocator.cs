...
/// rolls back returns its number. For the series that may not hold a gap — invoices, the notes and
/// receipts — where <see cref="Tailor360.Platform.Abstractions.Sequencing.ISequenceAllocator"/>, which commits
