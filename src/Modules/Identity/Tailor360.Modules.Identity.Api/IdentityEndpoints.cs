...
/// </summary>
/// <remarks>
/// Eleven groups are mapped from one extension method, which is what the host composes (architecture rule
...
public static class IdentityEndpoints
{
    ...
    public static IEndpointRouteBuilder MapIdentityEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapGroup(IdentityRoutes.AdminRoles)
            .WithTags(IdentityRoutes.AdminTag)
            .MapRoleAdminEndpoints();

        endpoints.MapGroup(IdentityRoutes.AdminPermissions)
            .WithTags(IdentityRoutes.AdminTag)
            .MapPermissionCatalogueEndpoints();

        endpoints.MapGroup(IdentityRoutes.AdminFeatureFlags)
            .WithTags(IdentityRoutes.AdminTag)
            .MapFeatureFlagAdminEndpoints();

        endpoints.MapGroup(IdentityRoutes.AdminOutbox)
            .WithTags(IdentityRoutes.AdminTag)
            .MapOutboxAdminEndpoints();

        endpoints.MapGroup(IdentityRoutes.AdminAudit)
            .WithTags(IdentityRoutes.AdminTag)
            .MapAuditAdminEndpoints();
