...
/// </summary>
/// <remarks>
/// A copy of the Catalog, Identity and Customers modules' class, and deliberately a copy rather than a
/// shared helper: a module may not reference another module's <c>Api</c> project (ARCH-004), and the
