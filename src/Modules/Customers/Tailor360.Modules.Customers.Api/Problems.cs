...
/// </summary>
/// <remarks>
/// A copy of the Identity module's class, and deliberately a copy rather than a shared helper: a
/// module may not reference another module's <c>Api</c> project (ARCH-004), and the platform publishes
/// <c>ProblemResults</c>, which takes a status and a code rather than an <see cref="Error"/>. The
/// status and title tables below are identical to Identity's on purpose — two modules answering one
/// classification two ways is the drift this comment exists to make visible if it ever happens.
/// </remarks>
/// <remarks>
/// <para>
