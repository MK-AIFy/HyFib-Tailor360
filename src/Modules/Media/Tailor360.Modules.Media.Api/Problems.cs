...
/// </summary>
/// <remarks>
/// A copy of Catalog's, Billing's, Customers', Identity's and Orders' own class, and deliberately a
/// copy rather than a shared helper: a module may not reference another module's <c>Api</c> project
/// (ARCH-004). The status and title tables below are identical to theirs on purpose — see Catalog's
/// own remarks on this type for why that sameness is the point.
/// </remarks>
